        ...
        <tr>
          <td>
            <div class="d-flex align-items-center">
              <img src="../../controllers/<?php echo $pro[
                  'anh'
          ...
          <td width=20%>
            <p class="fw-normal mb-1 text-center" style="color: red;">
              <?= number_format($pro['price'], 0, ',', '.') . ' VNĐ' ?></p>
          </td>
          <td width=10%>
            <p class="text-muted mb-0 text-center"><?= $pro['so_luong'] ?></p>
          </td>
          <td width=20% style="color: red;" class="text-center">
            <?= number_format($pro['price'] * $pro['so_luong'], 0, ',', '.') .
                ' VNĐ' ?></td>
          <td width=10%>
            <a href="../../controllers/deleteCart.php?id=<?= $pro['id'] ?>"
